...
export default function Sidebar({ onAddSecret, onEditSecret, onUpgrade, onSettings, onDashboard, currentView = 'dashboard', mobileMenuOpen = false, onCloseMobileMenu }: SidebarProps) {
