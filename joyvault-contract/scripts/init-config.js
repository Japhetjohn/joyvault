...
async function main() {
  ...
  // Use the test wallet with 12 SOL
  // Private key: [174,47,154,16,202,193,206,113,199,190,53,133,169,175,31,56,222,53,138,189,224,216,117,173,10,149,53,45,73,251,237,246,123,154,216,120,11,247,163,153,211,169,236,72,192,200,31,185,215,129,240,90,77,233,138,175,238,66,105,148,99,246,157,67]
  // Public key: Hwnagq6nu7tLMDYaaDLnQ4X4FiyfGv5hcMifYr13CZxd

  const testWalletSecretKey = [
  ...
  const testWallet = Keypair.fromSecretKey(Uint8Array.from(testWalletSecretKey))
  console.log('✅ Using wallet:', testWallet.publicKey.toString())
